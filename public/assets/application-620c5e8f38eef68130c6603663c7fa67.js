...
(function() {
  ...
  ready = function() {
    $('.artist-biography').each(function(index) {
      var fullText, shortText, words;
      ...
      if (fullText.length > 1500) {
        ...
        $(this).text(shortText);
        return $(this).append("<a class='read-more-link'> read more</a>");
      }
    });
    $("body").on('click', '.read-more-link', function() {
      var fullText;
      fullText = $(this.parentElement).data('full-text');
      return $(this.parentElement).html(fullText + "<a class='read-less-link'> read less</a>");
    });
    $("body").on('click', '.read-less-link', function() {
      var shortText;
      console.log('here');
      shortText = $(this.parentElement).data('short-text');
      return $(this.parentElement).html(shortText + "<a class='read-more-link'> read more</a>");
    });
    return $('a[class^=artwork-]').attr('rel', 'gallery').fancybox({
      padding: 0,
      beforeLoad: function() {
        var el;
...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=206d7e3d4609413da96f)
 * Config saved to config.json and https://gist.github.com/206d7e3d4609413da96f
 */
...
(function() {
  ...
  ready = function() {
    var show, _i, _len, _ref, _results;
    $('.ind-show-paragraph-truncated').each(function(index) {
      var fullText, shortText, words;
      fullText = this.textContent;
    ...
    $('a[class=current-show-artwork]').attr('rel', 'gallery').fancybox({
      padding: 0,
      beforeLoad: function() {
        var el;
        el = $(this.element).find('.artwork-title');
    ...
    _ref = $("*[class^='show-right-']");
    _results = [];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      show = _ref[_i];
      _results.push($(show).find('.show-artwork').attr('rel', 'gallery-' + $(show).data('show')).fancybox({
        padding: 0,
        beforeLoad: function() {
          var el;
          el = $(this.element).find('.artwork-title');
